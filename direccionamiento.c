...
// }
//
// void camino_corto(EDIF *inicio, char camino[60], char o, char d);
//
// void recorre_red(EDIF *inicio)
// {
//     char camino[60], o, d;
...
//     scanf(" %c", &d);
//
//     camino_corto(inicio, camino, o, d);
// }
//
// void camino_corto(EDIF *inicio, char camino[60], char o, char d)
// {
...
//             auxe = auxe->sig;
//         }
//         auxc = auxe->conexiones;
//         while (auxc != NULL) {
//             v = 0;
//             for (i = 0; i < strlen(camino); i++) {
//                 if (camino[i] == auxc->nombre) {
//                     v = 1;
//                 }
//             }
//             if (v == 0) {
//                 camino_corto(inicio, camino, auxc->nombre, d);
//             }
//             auxc = auxc->sig;
//         }
//     }
